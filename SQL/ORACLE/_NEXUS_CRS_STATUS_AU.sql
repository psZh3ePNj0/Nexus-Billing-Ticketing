/*************************************************************************************
**                                                                					**
** Trigger Name : _NEXUS_CRS_STATUS_AU	          									**
...
--DROP TRIGGER _NEXUS_CRS_STATUS_AU;

CREATE OR REPLACE TRIGGER _NEXUS_CRS_STATUS_AU
...
BEGIN
		...
		IF (:old.column_s <> :new.column_s) THEN

			--===========================================================================================================--	

			_NEXUS_APP_PKG.NEXUS_GET_RATECD_INFO(:new.column_i,:new.column_j,:new.column_k,/*.....*/local_variable_i,local_variable_j,
			/*.....*/local_variable_n);
...
EXCEPTION
		...
		------------------------------------------------------
			...
			VALUES('TRIGGER -> _NEXUS_CRS_STATUS_AU','<desired_value>',/*.....*/SYSDATE,error);

/**********************************************************/

END _NEXUS_CRS_STATUS_AU;
/