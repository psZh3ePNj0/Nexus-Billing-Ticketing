/*************************************************************************************
**                                                                					**
** Trigger Name : _NEXUS_WIP_RATECD_AI	          									**
...
--DROP TRIGGER _NEXUS_WIP_RATECD_AI;

CREATE OR REPLACE TRIGGER _NEXUS_WIP_RATECD_AI
...
EXCEPTION
		...
		------------------------------------------------------
			...
			VALUES('TRIGGER -> _NEXUS_WIP_RATECD_AI','<desired_value>',/*.....*/SYSDATE,error);

/**********************************************************/

END _NEXUS_WIP_RATECD_AI;
/