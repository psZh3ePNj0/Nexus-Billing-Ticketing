/*************************************************************************************
**                                                                					**
** Trigger Name : _NEXUS_CRS_STATUS_AI	          									**
...
--DROP TRIGGER _NEXUS_CRS_STATUS_AI;

CREATE OR REPLACE TRIGGER _NEXUS_CRS_STATUS_AI
...
/**********************************************************/
	EXCEPTION
  	WHEN OTHERS THEN 
		...
		VALUES('TRIGGER -> _NEXUS_CRS_STATUS_AI','<desired_value'>,/*.....*/SYSDATE,error);


/**********************************************************/

END _NEXUS_CRS_STATUS_AI;
/